...
namespace KatMyha.Scripts.Enemies.DroneEnemy.States
{
    public abstract partial class StateMachine : Node
    {
        ...
        private Dictionary<EnumEnemyState, EnemyStateBase> _states = new();
        ...
        public void RegisterState(EnumEnemyState stateType, EnemyStateBase state)
        {
            if (state == null)
            {
        ...
        public void ChangeState(EnumEnemyState newStateType)
        {
        ...
        public bool HasState(EnumEnemyState stateType)
        {
            return _states.ContainsKey(stateType);
        }

        public IEnumerable<EnumEnemyState> GetRegisteredStates()
        {
            return _states.Keys;
        }
    }
